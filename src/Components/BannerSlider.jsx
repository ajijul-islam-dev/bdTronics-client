...
const BannerSlider = () => {
  return (
    <div>
      ...
      >
        <SwiperSlide>
          <img className="w-full h-full" src={slide_1} alt="Slide 1" />
        </SwiperSlide>
        <SwiperSlide>
          <img className="w-full h-full" src={slide_2} alt="Slide 2" />
        </SwiperSlide>
        <SwiperSlide>
          <img className="w-full h-full" src={slide_3} alt="Slide 3" />
        </SwiperSlide>
      </Swiper>
    </div>
  );
