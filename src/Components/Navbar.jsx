      ...
      <div className='md:container mx-auto flex items-center justify-between gap-5 md:gap-0'>
        ...
        <div>
          <form className='grid grid-cols-12 border border-primary rounded-full overflow-hidden'>
            <input className='col-span-9 outline-none py-1 px-2' type='text' placeholder='Search here'/>
            <button className='col-span-3 bg-primary text-2xl flex items-center justify-center' type='submit'>
              <IoIosSearch/>
            </button>
          </form>
        </div>
